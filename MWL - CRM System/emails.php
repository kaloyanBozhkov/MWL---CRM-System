...
if($('#cCHecker').length == 1){
    ...
    $(document).on('click', '#saveChanges', function(){
        var details = [
            $('#emailaddressId').html().toString().trim(),
            $('#emailFull').val().toString().trim(),
            $('#branchCompanyId option:selected').attr('id').toString().trim(),             
            $('#emailType').val().toString().trim(),
            $('#delete').val().toString().trim()
        ];

        var detailNames = [
            $('#emailaddressId').parent().siblings('th').children().html().toString().trim(),
            $('#emailFull').parent().siblings('th').children().html().toString().trim(), 
            $('#branchCompanyId').parent().siblings('th').children().html().toString().trim(),
            $('#emailType').parent().siblings('th').children().html().toString().trim(),
